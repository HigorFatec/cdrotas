...
class CaixasScreen extends StatefulWidget {
  ...
  const CaixasScreen({Key? key, this.caixaSelecionada}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _CaixasScreenState createState() => _CaixasScreenState();
}

class _CaixasScreenState extends State<CaixasScreen> {
  final List<Caixa> _caixas = [];
  ...
  void _removerCaixa(int index) async {
    if (index >= 0 && index < _caixas.length) {
      ...
      final docRef = FirebaseFirestore.instance.collection('caixas').doc(docId);
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () {
                                Navigator.pushNamed(context, '/listcaixa');
                              },
                              child: AbsorbPointer(
                                absorbing: true,
                                child: TextField(

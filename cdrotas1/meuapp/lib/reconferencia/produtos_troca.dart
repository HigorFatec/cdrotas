...
Future<List<Troc2>?> fetchDevolucoesFromExcel() async {
...
class TrocaScreen2 extends StatefulWidget {
  const TrocaScreen2({Key? key}) : super(key: key);

  @override
  _TrocaScreenState2 createState() => _TrocaScreenState2();
}

class _TrocaScreenState2 extends State<TrocaScreen2> {

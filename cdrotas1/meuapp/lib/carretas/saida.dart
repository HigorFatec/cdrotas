...
class SaidaGerais extends StatefulWidget {
  const SaidaGerais({Key? key}) : super(key: key);

  @override
  State<SaidaGerais> createState() => _SaidaGeraisState();
}

class _SaidaGeraisState extends State<SaidaGerais> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Saida Carretas'),
      ),
                              ...
                              trailing: FloatingActionButton(
                                onPressed: () async {
                                  try {
                                    ...
                                    await moverDados('QuarentenaCarreta',
                                        'SaidaCarreta', dts[index]);
  ...
  Future<List<String>> getDTS() async {
    final snapshot =
        await FirebaseFirestore.instance.collection('QuarentenaCarreta').get();
